...
export type WorkflowEvent =
  ...
  | { readonly type: 'phase:complete';    readonly phase: WorkflowPhase; readonly durationMs: number; readonly artifacts: readonly string[] }
  | { readonly type: 'phase:error';       readonly phase: WorkflowPhase; readonly operation: string; readonly error: string }
  | { readonly type: 'approval:required'; readonly phase: WorkflowPhase; readonly artifactPath: string; readonly instruction: string }

...
import type { Tool, ToolContext, MemoryEntry } from '../../domain/tools/types';
...
export const retrieveSpecTool: Tool<RetrieveSpecInput, RetrieveSpecOutput> = {
  name: 'retrieve_spec',
  description:
    'Read the requirements, design, and tasks documents for a named spec from .kiro/specs/<specName>/.',

...
RULES=(
  ...
  "src/infra/llm/|src/infra/llm/ src/application/ports/ src/domain/ src/infra/utils/|src/application/usecases/ src/application/services/ src/adapters/ src/main/di/|Concrete port implementations only"
  "src/infra/git/|src/infra/git/ src/application/ports/ src/domain/ src/infra/utils/|src/application/usecases/ src/application/services/ src/adapters/ src/main/di/|Concrete port implementations only"
  "src/infra/safety/|src/infra/safety/ src/application/ports/ src/domain/ src/infra/utils/|src/application/usecases/ src/application/services/ src/adapters/ src/main/di/|Concrete runtime safety integrations only"
  "src/infra/sdd/|src/infra/sdd/ src/application/ports/ src/domain/ src/infra/utils/|src/application/usecases/ src/application/services/ src/adapters/ src/main/di/|Concrete port implementations only"
  "src/infra/tools/|src/infra/tools/ src/application/ports/ src/domain/ src/infra/utils/|src/application/usecases/ src/application/services/ src/adapters/ src/main/di/|Tool execution implementation only"
  "src/infra/memory/|src/infra/memory/ src/application/ports/ src/domain/ src/infra/utils/|src/application/usecases/ src/application/services/ src/adapters/ src/main/di/|Persistence implementation only"
  "src/infra/planning/|src/infra/planning/ src/application/ports/ src/domain/ src/infra/utils/|src/application/usecases/ src/application/services/ src/adapters/ src/main/di/|Planning persistence implementation only"
  "src/infra/events/|src/infra/events/ src/application/ports/ src/domain/ src/infra/utils/|src/application/usecases/ src/application/services/ src/adapters/ src/main/di/|Event transport implementation only"
  "src/infra/state/|src/infra/state/ src/application/ports/ src/domain/ src/infra/utils/|src/application/usecases/ src/application/services/ src/adapters/ src/main/di/|Workflow state persistence only"
  "src/infra/config/|src/infra/config/ src/application/ports/ src/domain/ src/infra/utils/|src/application/usecases/ src/application/services/ src/adapters/ src/main/di/|Runtime config loading only"
  "src/infra/implementation-loop/|src/infra/implementation-loop/ src/application/ports/ src/domain/ src/infra/utils/|src/application/usecases/ src/application/services/ src/adapters/ src/main/di/|Implementation loop persistence only"
  "src/infra/logger/|src/infra/logger/ src/application/ports/ src/domain/ src/infra/utils/|src/application/usecases/ src/application/services/ src/adapters/ src/main/di/|Logger implementations only"
  "src/infra/utils/|src/infra/utils/ src/domain/|src/application/ src/adapters/ src/main/di/|Shared infra utilities only"
  "src/main/di/|src/main/di/ src/application/usecases/ src/application/services/ src/application/ports/ src/adapters/cli/ src/infra/ src/domain/||DI wires services and infra; never calls back into main"
